  ...
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        dailyMap: state.dailyMap,
        dailyAttempts: state.dailyAttempts,
        dailyLeaderboard: state.dailyLeaderboard,
        isLoadingDailyLeaderboard: state.isLoadingDailyLeaderboard,
        dailyLeaderboardError: state.dailyLeaderboardError,
        userDailyRank: state.userDailyRank,
